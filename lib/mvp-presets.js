export function buildDemoAnalysis() {
  return {
    ...
    moodTags: ["자신감", "야망", "집중감"],
    structure: [
      { label: "Intro", seconds: 16, intensity: "low" },
      { label: "Verse 1", seconds: 32, intensity: "medium" },
      { label: "Hook", seconds: 16, intensity: "high" },
      { label: "Verse 2", seconds: 28, intensity: "medium" }
    ]
  };
}
